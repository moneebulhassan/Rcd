            ...
            <div class="card-content">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('branches.edit',$branch->id) }}" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Edit Branch">
                        ...
                        /
                            <form action="{{ route('branches.destroy', $branch->id) }}" method="post" class="d-inline">
                                ...
                                <button type="button" class="btn btn-link" data-toggle="tooltip" data-placement="bottom" title="Delete Client"
                                        onclick="confirm('Are you sure you want to delete this Branch.') ? this.parentElement.submit() : ''">
