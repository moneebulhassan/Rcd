<ul>
    ...
    <li class="nav-item @if(request()->routeIs('branches.index')) active @endif">
        <a href="{{ route('branches.index') }}">
            ...
            <span class="text">{{ __('Branches') }}</span>
        </a>
    </li>

    <li class="nav-item @if(request()->routeIs('links.index')) active @endif">
    ...
    <li class="nav-item @if(request()->routeIs('registerperson.index')) active @endif">
        <a href="{{ route('registerperson.index') }}">
            <span class="icon">
                <svg width="22" height="22" aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                    <path d="M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z"></path>
                </svg>
            </span>
            <span class="text">{{ __('Register Person') }}</span>
        </a>
    </li>
